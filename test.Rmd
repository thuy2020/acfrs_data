...
nces_ELSI <- nces_20 %>% left_join(nces_21) %>% left_join(nces_22) %>% 
  rename(name = 1,
         ...
         revenue_20 = `Total Revenue (TOTALREV) [District Finance] 2019-20`,
         revenue_21 = `Total Revenue (TOTALREV) [District Finance] 2020-21`,
         
         expenditure_20 = `Total Expenditures (TOTALEXP) [District Finance] 2019-20`,
         expenditure_21 = `Total Expenditures (TOTALEXP) [District Finance] 2020-21`
...
top_schools_by_year <- nces_ELSI %>% arrange(desc(enrollment_20)) %>%
