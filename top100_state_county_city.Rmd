...
top100_county_3years <- county_all %>% 
  ...
  #TODO: pull from acfrvalue table
  ...
  mutate(total_assets = ifelse(name == "st louis county" & year == 2020, 2138938727, total_assets), 
         ...
         net_pension_assets = ifelse(name == "oklahoma county", 0, net_pension_assets),
         net_opeb_assets = ifelse(name == "oklahoma county", 0, net_opeb_assets),
...
top100_county_3years %>% filter(state.abb == "NJ")
