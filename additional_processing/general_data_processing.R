...
# read in data
county_data_temp <- read_csv("https://raw.githubusercontent.com/thuy2020/acfrs_data/main/output/top100_counties_3years.csv")
city_data_temp <- read_csv("https://raw.githubusercontent.com/thuy2020/acfrs_data/main/output/top100_cities_3years.csv")
state_data_temp <- read_csv("https://raw.githubusercontent.com/thuy2020/acfrs_data/main/output/all_states_3years.csv")
school_data_temp <- read_csv("https://raw.githubusercontent.com/thuy2020/acfrs_data/main/output/top100_sd_3years.csv")
...
# Filter 2022 data for all states and 2021 data for California
state_data_22 <- state_data |>
  filter((year == 2022 & name != "California") | (year == 2021 & name == "California")) |>
  mutate(year = if_else(name == "California", 2022, year)) |>
  rename_with(~ paste0(., "_22"))
