...
dw_state_data_growth <- state_data_growth |>
  mutate(
...
write_csv(dw_state_data_growth, "output/dw_state_data_growth.csv")
...
write_csv(state_data, "output/dw_state_data.csv")
...
dw_county_data_growth <- county_data_growth |>
  mutate(
    total_liabilities_growth = total_liabilities_growth * 100,
    net_pension_liability_growth = net_pension_liability_growth * 100,
    expenses_growth = expenses_growth * 100
...
write_csv(dw_county_data_growth, "output/dw_county_data_growth.csv")
...
city_data <- modify_data(city_data_temp) %>% 
  ...
  mutate(name = ifelse(name != "District Of Columbia", paste(name, `state.abb`, sep = ", "), "District Of Columbia"))
...
dw_city_data_growth <- city_data_growth |>
  mutate(
    total_liabilities_growth = total_liabilities_growth * 100,
    net_pension_liability_growth = net_pension_liability_growth * 100,
    expenses_growth = expenses_growth * 100
...
write_csv(dw_city_data_growth, "output/dw_city_data_growth.csv")
...
dw_school_data_growth <- school_data_growth |>
  mutate(
    total_liabilities_growth = total_liabilities_growth * 100,
    net_pension_liability_growth = net_pension_liability_growth * 100,
    expenses_growth = expenses_growth * 100
