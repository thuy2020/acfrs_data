...
# dict_top101_200 
#   dictionary %>% 
#   filter(ncesID %in% c(setdiff(dict_top101_200$ncesID, sd101_200_3years$ncesID)))
# setdiff(dict_top101_200$ncesID, sd101_200_3years$ncesID) -> not_matched_id
# 
# dictionary %>% 
#   filter(ncesID %in% not_matched_id) %>% select(ncesID, name, state) -> ncesID_missing
# 
# sub_dictionary <- data.frame(
#              ncesID = ncesID_missing$ncesID, 
#              name = ncesID_missing$name, 
#              state = ncesID_missing$state,
#              id = c(NA, "1240465", "146253", "146581", "86286", "146589", "1265439", "1265761")
#             )
...
top100_sd_3years <- sd_20_21_22 %>% 
  ...
  select(state.abb, state.name, ncesID, year, name, 
         total_liabilities, net_pension_liability, net_opeb_liability, 
         net_pension_assets, net_opeb_assets,
