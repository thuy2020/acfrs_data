...
summary_by_year_data_2020 <- summary_by_year_data %>% filter(year == 2020)
summary_by_year_data_2020

summary_by_year_data_2021 <- summary_by_year_data %>% filter(year == 2021)
summary_by_year_data_2021

```

```{r}
summary_by_year_data_2022 <- summary_by_year_data %>% filter(year == 2022)
summary_by_year_data_2022
