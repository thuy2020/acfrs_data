...
#########Partisan ~ debt ratio###########
cor.test(cor_data$partisan_lean, cor_data$debt_ratio, method = "spearman")
# Plot 
plot(cor_data$partisan_lean, cor_data$debt_ratio, 
     main = "Scatter Plot of Partisan Lean vs. Debt Ratio", 
     xlab = "Partisan Lean", ylab = "Debt Ratio")
# Kendall's Tau
cor.test(cor_data$partisan_lean, cor_data$debt_ratio, method = "kendall")

########Partisan ~ free_cash_flow###########
# Plot the variables to visually inspect the relationship
cor.test(cor_data$partisan_lean, cor_data$free_cash_flow, method = "spearman")
plot(cor_data$partisan_lean, cor_data$free_cash_flow, 
     main = "Scatter Plot of Partisan Lean vs. Free Cash Flow", 
     xlab = "Partisan Lean", ylab = "Free Cash Flow")
# Kendall's Tau
cor.test(cor_data$partisan_lean, cor_data$free_cash_flow, method = "kendall")
